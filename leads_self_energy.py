...
class SelfEnergy: 
    ...
    def sgf(self , num , k_y):
        if(parameters.chain_length_y == 1):
            ...
            for r in range(0 , parameters.steps):
                self.surface_gf_l[r][num][0][0] = 1 / (parameters.energy[r] - parameters.voltage_l[self.voltage_step] - parameters.onsite_l - 2 * parameters.hopping_l * np.cos(k_y) - parameters.hopping_lx * self.transfer_matrix_l[r][0][0] )
